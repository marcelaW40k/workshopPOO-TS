...
const persona: Persona[] = [
  new Persona("Marcela Patiño", 20, {calle: "numero 1", ciudad: "Bogotá", pais: "Colombia"}, [coche1, moto1]),
  new Persona("Juan Perez", 21, {calle: "numer0 2", ciudad: "Cali", pais: "Colombia"},[moto2]), 
  new Persona("Carlos Santos", 22, {calle: "numero 3", ciudad: "Medellin", pais: "Colombia"}, [moto1, moto2]),
  new Persona("Ana Sanchez",  23, {calle: "numero 4", ciudad: "Cartagena", pais: "Colombia"}, [moto1]),
  new Persona("Pablo Lopez", 24, {calle: "numero 5", ciudad: "Neiva", pais: "Colombia"}, [coche1, coche2]),
  new Persona("Olga Patiño", 25, {calle: "numero 6", ciudad: "Barranquilla", pais: "Colombia"}, [coche2]),
  new Persona("Luis Cania", 26, {calle: "numero 7", ciudad: "Tolima", pais: "Colombia"}, [coche1, moto1, moto2]),
  new Persona("Camila Patiño", 27, {calle: "numero 8", ciudad: "Bogotá", pais: "Colombia"}, [moto1, coche1, coche2]),
  new Persona("Marua Rivera", 28, {calle: "numero 9", ciudad: "Cundinamarca", pais: "Colombia"}, [moto1, moto2, coche2]),
  new Persona("Sandra Caicedo", 29, {calle: "numero 10", ciudad: "Bogotá", pais: "Colombia"}, [coche1, coche2, moto1, moto2])
]
